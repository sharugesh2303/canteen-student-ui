...
const LockIcon = ({ className }) => (<svg xmlns="http://www.w3.org/2000/svg" className={className} width="1em" height="1em" viewBox="0 0 448 512" fill="currentColor"><path d="M144 160C144 89.6 202.7 32 272 32c70.5 0 128 57.6 128 128v48H144V160zm144 48H448c8.8 0 16 7.2 16 16v240c0 8.8-7.2 16-16 16H0c-8.8 0-16-7.2-16-16V224c0-8.8 7.2-16 16-16h144V160c0-70.4 57.6-128 128-128s128 57.6 128 128v48z"/></svg>);
...
const RegisterPage = () => {
    ...
    const handleSendOtp = async (e) => {
        ...
        try {
            // Updated payload, removing registerNumber
            const response = await axios.post('http://localhost:5000/api/auth/register-email-otp', { name, email });
    ...
    const handleVerifyOtp = async (e) => {
        ...
        try {
            // Updated payload, removing registerNumber
            const response = await axios.post('http://localhost:5000/api/auth/verify-email-otp', { email, otp, password });
